<?php include("includes/header.php"); 
	...
	$due1= @mysqli_fetch_array(@mysqli_query($con,"select sum(pay_amount)as total from transaction where type='purchase' and status='due' $whereclassOne"));
   ...
   <table width="400px" class="tab form" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="4%">
						...
						<?php
						$nameSql =mysqli_query($con, "SELECT * FROM personinformation WHERE type='supplier'");
...
<div style="overflow:hidden;padding:10px;margin-bottom:10px;text-align: right;" >	
		...
		<a  href="download_supplier_report.php?from=<?= $f ?>&to=<?= $t ?>&customer=<?= $c ?>" class="btn-add">Export/Print</a>
</div>
