...
<?php 
	...
	$autoid1 = "SL-" . $max . "";
		...
		for($i=0;$i<sizeof($_POST['stock_name']);$i++){
			...
			header("Location:pos_print.php?sid=$p_id");
		}else{
		...
		<div class="prodright left fix">
			<div class="customer_details fix">
				<table>
					<tr>
						<td>Date: </td>
						<td><input name="date" type="text" id="datee"
								   maxlength="200" value="<?= date('d/m/Y') ?>" class="form-control datepick" style="width:250px" required/></td>
					</tr>
					<tr>
						<td>Customer: </td>
					...
					<tr>
						...
						<td><input name="contact" placeholder="" type="text" id="contact1"
								   ...
								   onkeypress="return numbersonly(event)" style="width:250px " required/></td>
					</tr>
				</table>
			</div>
			<hr />
			<div class="totalamount fix">
				...
				<table id="pay_what">
					...
					<tr>
						...
						<td width="50%"><input type="text" class="form-control" onkeyup=" balance_amount(); "
										   onkeypress="return numbersonly(event);" name="payment" id="payment" style="width: 120px" required></td>
					</tr>
					<tr>
				...
				<table width="280">
					<tr>
						<td align="right"><input type="submit" onclick="return chkdata();" name="submit11" value="Add Sale" /><td>
					</tr>
				</table>
			</div>
			</form>
