...
<a href="salary_payment.php">Cancel</a>
            ...
            <table width="695" cellspacing="0" cellpadding="0" id="bordertable" border="1">
                ...
                <tr>
                    <td height="90" align="left" valign="top"><br/>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
						<?php 
						$nam = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `personinformation` where id = '".$data['employee_id']."'"));
						if($nam['name']!=''){					
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td  align="center" bgcolor="#CCCCCC">Year</td>
                                <td  align="center" bgcolor="#CCCCCC">Month</td>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $data['salary_monty']; ?></td>
                                    <td align="center"><?php echo $data['amount'].' TK'; ?></td>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="28%" bgcolor="#CCCCCC"><?php echo $data['amount'].' TK' ?>&nbsp;</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="45%" align="left" valign="top"><br/>
									...
									&nbsp;&nbsp;Payment Method :&nbsp;&nbsp;<strong><?php echo $data['mode'] ?></strong><br/>
