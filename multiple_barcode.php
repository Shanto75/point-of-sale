...
<style type="text/css">
body{width:100%}
.barcode{width:40%;height: auto;float:left;margin-right:10px;text-align:center;padding: 20px 0px;}
...
$data = '';
	...
	$data .= '<p>Name -'.$name.'</p>';
	$data .= '<img src="data:image/png;base64,' . base64_encode($generatorPNG->getBarcode($item_id, $generatorPNG::TYPE_CODE_128)) . '">';
	$data .= '<p>'.$item_id.'</p>';
