...
$pdf->SetTitle('Supplier Ledger Report');
$pdf->SetSubject('Supplier Ledger Report');
...
$pdf->SetHeaderData('', '','Supplier Ledger Report', $pdf_header_strng, array(0,64,255), array(0,64,128));
...
$pdf->Output('Supplier Ledger Report', 'I');	
