...
<div class="area">
		<div class="panel-head">Receive Reports</div>
		<div class="panel">
...
<!--<div style="overflow:hidden;padding:10px;margin-bottom:10px;float:left" >	
		<a  href="generate_receive_report.php?from=<?= $f ?>&to=<?= $t ?>&customer=<?= $c ?>" class="btn-add">Print</a>		
</div>-->

<div style="overflow:hidden;padding:10px;margin-bottom:10px;" >	
		<a  href="download_receive_report.php?from=<?= $f ?>&to=<?= $t ?>&customer=<?= $c ?>" class="btn-add">PDF Download</a>		
</div>
