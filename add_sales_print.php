                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            while ($row = mysqli_fetch_array($prod)) {
                                ...
                                <tr>
                                    ...
                                    <td align="left"><?php echo ucwords($row['product_name']); ?></td>
                                    <td align="left"><?php echo ($row['pcode']); ?></td>
                                    <td align="left"><?php echo $row['quantity'].' '.$find_prod['unit_type']; ?></td>
                                    <td align="left"><?php echo $row['sale_price'].' TK' ?></td>
                                    <td align="left"><?php echo $row['discount_prod'].' TK' ?></td>
                                    <td align="left"><?php echo $row['total'].' TK' ?></td>
                                </tr>
                                <?php
                                $i++;
