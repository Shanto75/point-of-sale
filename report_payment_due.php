...
<div class="area">
		<div class="panel-head">Payment Due Reports</div>
		<div class="panel">
...
?>
    <tr>
            ...
            <td>
				<a onclick="return payment_history('<?= $row['supplier'] ?>','purchase');" href="javascript:;"id="modal-launcher" class="view">Payment History</a>
            </td>
    </tr>
<?php } ?> 
    </tbody>
