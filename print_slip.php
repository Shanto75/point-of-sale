...
<?php 
if($data['slip']=='Supplier Payment'){
	echo '<a href="payment.php">Cancel</a>';
}
?>
                    ...
                    <td height="90" align="left" valign="top"><br/>
						...
						<?php 
							if($data['name']!=''){
                                ...
                                $customerName = mysqli_fetch_array(mysqli_query($con, "SELECT name FROM personinformation WHERE type='supplier' AND id='".$data['name']."'"));
						?>
                            <tr>
                ...
                <tr>
                    <td>
                        <table width="101%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td  align="center" bgcolor="#CCCCCC">Payable Amount</td>
                                <td  align="center" bgcolor="#CCCCCC">Paid Amount</td>
                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td width="90%" align="right" bgcolor="#CCCCCC"><strong>Payment Amount:&nbsp;&nbsp;</strong>
                                </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="45%" align="left" valign="top"><br/>
                                    ...
                                    &nbsp;&nbsp;Total Paid Amount :&nbsp;&nbsp;<strong><?php echo ($data['paid_amount']+$data['pay']).' TK'; ?></strong><br/>									
                                        &nbsp;&nbsp; Total Due Balance
