...
<?php 
	...
	$autoid1 = "ST-" . $max . "";
		...
		echo "<script type='text/javascript'>window.open('add_purchase_print.php?sid=$p_id','myNewWinsr','width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no');</script>";
	}
?>	
<div class="area" >
